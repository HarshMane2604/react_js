...
function Card(  ) {
  return (
    <div>
      <div class="max-w-sm rounded-2xl overflow-hidden shadow-xl bg-white p-6 transition-transform transform hover:scale-105 hover:shadow-2xl">
        <img
        ...
        <div class="mt-4">
          ...
          <button class="mt-4 bg-gradient-to-r from-blue-500 to-purple-500 text-white px-5 py-2 rounded-lg hover:opacity-90 transition-all">
            Learn More
          </button>
        </div>
      </div>
